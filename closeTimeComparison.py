...
"""
This file compares the speed of the brute force vs the divide and conquer.
"""
...
def ply_timer(num_trial = int, poly_name = str, function = object, brute = bool):
...
ply_timer(3000, "Brute Force", pointsBrute, True)
ply_timer(7500, "Divide and Conquer", pointsDivideStart, False)